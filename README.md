...
- Figure out how to handle azkar when the counter could conflict with the logic, like for example when reading something that takes 1 count normally but 3 after other prayers. Maybe add conditions to cancel
the counter ui and make the card dismiss with one tap instead of count.
